    ...
    <main id="card-content">
        <div id="zname_total_wrapper">
            <div id="profile_section">
                ...
                <div id="social_link">
                    <input id="facebook_link" type="url" placeholder="https://페이스북링크.com" name="facebook" pattern="https://.*" minlength="2" maxlength="20" size="16">
                    <a href="">
                        <img src="{{ asset('images/card/socialfacebookicon.png') }}">
                    </a>
                    <input id="twitter_link" type="url" placeholder="https://트위터링크.com" name="twitter" minlength="2" maxlength="20" size="16">
                    <a href="">
                        <img src="{{ asset('images/card/socialtwittericon.png') }}">
                    </a>
                    <input id="instagram_link" type="url" placeholder="https://인스타그램링크.com" name="instagram" minlength="2" maxlength="20" size="16">
                    <a href="">
                        <img src="{{ asset('images/card/socialinstagramicon.png') }}">
                    </a>
                    <input id="band_link" type="url" placeholder="https://네이버밴드링크.com" name="band" minlength="2" maxlength="20" size="16">
                    <a href="">
                        <img src="{{ asset('images/card/socialbandicon.png') }}">
                    </a>
                    <input id="kakao_link" type="url" placeholder="https://카카오톡링크.com" name="kakao" minlength="2" maxlength="20" size="16">
                    <a href="">
