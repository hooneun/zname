...
(function() {
  ...
  ContentTools.ImageDialog = (function(_super) {
    ...
    ImageDialog.prototype.mount = function() {
      ...
      this._domUpload.textContent = ContentEdit._('');
      ...
      this._domInsert.textContent = ContentEdit._('');
      ...
      this._domCancelUpload.textContent = ContentEdit._('');
      ...
      this._domClear.textContent = ContentEdit._('');
    ...
    ImageDialog.prototype.populate = function(imageURL, imageSize) {
      ...
      this._domImage.style['background-image'] = "url(" + imageURL.replace(/ /g,'%20') + ")";
      this._domImage.setAttribute('data-image-path', imageURL);
      this._domImage = null;
      ...
      this._domInput.addEventListener('change', (function(_this) {
        return function(ev) {
          ...
          reader.onload = function(e) {
            filePlus.preview = e.target.result;
            filePlus.data = file;
  ...
  ContentTools.PropertiesDialog = (function(_super) {
    ...
    PropertiesDialog.prototype.mount = function() {
      ...
      this._domApply.textContent = ContentEdit._('');
  ...
  ContentTools.VideoDialog = (function(_super) {
    ...
    VideoDialog.prototype.mount = function() {
      ...
      this._domButton.textContent = ContentEdit._('');
