...
@section('content')
    <div class="container">
        ...
        제 1 조 (목적)
        이 약관은 제트네임(이하 "회사" 또는 “제트네임”)이 제공하는 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다

        제 2 조 (정의)
        * 이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
        * "서비스"라 함은 구현되는 단말기 (PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 제트네임 관련 제반 서비스를 의미합니다.
